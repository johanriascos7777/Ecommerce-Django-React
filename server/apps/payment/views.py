...
# IMPORTANTE GATEWAY DE PAGO DE BRAINTREE, SE CONFIGURA CON LAS CREDENCIALES EN EL ARCHIVO .env Y SE USA EN LAS VIEWS DE ABAJO PARA GENERAR TOKEN Y PROCESAR PAGOS

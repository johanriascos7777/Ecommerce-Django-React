...
import { get_user_profile } from '../redux/actions/profile'; // ✅ agregado del tutorial
  ...
  useEffect(() => {
    const initializeAuth = async () => {
      try {
        ...
        // ✅ Cargamos el perfil del usuario al iniciar la app
        await dispatch(get_user_profile());

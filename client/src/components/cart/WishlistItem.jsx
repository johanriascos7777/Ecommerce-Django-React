...
// Heroicons v2 — rutas actualizadas
import { ArrowUpTrayIcon, XMarkIcon, CheckIcon, ClockIcon } from '@heroicons/react/24/solid';
// antes: UploadIcon → ArrowUpTrayIcon, XIcon → XMarkIcon
...
const WishlistItem = ({
    ...
    const [formData, setFormData] = useState({ item_count: 1 });
            ...
            <div className="ml-4 flex-1 flex flex-col justify-between sm:ml-6">
                <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                    ...
                    <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        {/* Botón eliminar item de wishlist */}
                ...
                <p className="mt-4 flex text-sm text-gray-700 space-x-2">
                    {item.product && item.product !== null && item.product !== undefined && item.product.quantity > 0 ? (
                        <>

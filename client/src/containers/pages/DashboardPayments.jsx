...
// Links de navegación (estáticos, solo visuales)
const navigation = [
        ...
        <>
            <div>
                ...
                <div className="md:pl-64 flex flex-col flex-1">
                    ...
                    {/* ── Lista de órdenes / historial de pagos ── */}
                                        ...
                                        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                                            ...
                                            <div className="mt-8">
                                                <div className="space-y-12">
                                                    ...
                                                    {/* Verificamos que haya órdenes antes de iterar */}
                                                    {orders && orders !== null && orders.length > 0 ? (
                                                        orders.map((product, index) => (
                                                            <div key={index}>
                                                                ...
                                                                {/* Encabezado de la orden: transaction ID + fecha relativa */}
                                                                <div className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
                                                                    <dl className="flex">
                                                                        ...
                                                                        <dd className="font-medium text-gray-900">
                                                                            {/* moment convierte la fecha a formato relativo: "hace 2 días" */}
                                                                ...
                                                                <div className="grid grid-cols-1 text-sm sm:grid-rows-1 sm:grid-cols-12 sm:gap-x-6 md:gap-x-8 lg:gap-x-8">
                                                                    ...
                                                                    <div className="sm:col-span-12 md:col-span-7">
                                                                        ...
                                                                        {/* Estado del pedido con barra de progreso */}
                                                                        ...
                                                                        <div className="mt-6">
                                                                            ...
                                                                            {/* Etiquetas de progreso: Order placed → Processing → Shipped → Delivered */}
